...
def run_efficient(i_file_path, o_file_path):
    ...
    def divide_and_conquer(x, y):
        ...
        memory_info = process.memory_info()
        memory_used = max(
            memory_info.rss, optimal_left_alignment[2], optimal_right_alignment[2]
        )
        return (
            optimal_left_alignment[0] + optimal_right_alignment[0],
            optimal_left_alignment[1] + optimal_right_alignment[1],
            memory_used,
        )
...
if __name__ == "__main__":
    ...
    run_efficient(i_file_path=i_file_path, o_file_path=o_file_path)
